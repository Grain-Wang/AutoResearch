...
class BiologyAgentSandbox:
    ...
    def run_project(
        ...
        * If the original ``biology_plan.md`` is in the workspace already, we
          ...
          the existing artifacts and continues.  This is what stage-15 repair
    ...
    def _prepare_workspace(self, prompt_text: str) -> Path:
        ...
        If a ``REPAIR_PROMPT.md`` is present (written by the stage-16
        ...
        # _version_rollback_stages renames the live stage-13 to stage-13_v{N}
    ...
    def _build_metrics(
        ...
        root and are merged in here so stage 15 / the bench rubric see them.
        """
