"""Stages 7 & 9: Synthesis and hypothesis generation (stage 8 = baseline_reproduce)."""
...
def _execute_hypothesis_gen(
    ...
    *,
    ...
    # Hypotheses must target defects confirmed by the baseline reproduction gate
    # (stage 8). The defect report focuses the debate on that specific weakness.
    defect_report = _read_prior_artifact(run_dir, "defect_report.md") or ""
    if defect_report:
    ...
    return StageResult(
        ...
        evidence_refs=("stage-09/hypotheses.md",),
    )
