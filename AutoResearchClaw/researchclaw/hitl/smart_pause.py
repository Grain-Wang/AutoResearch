...
_STAGE_CRITICALITY: dict[int, float] = {
    ...
    8: 0.8,   # BASELINE_REPRODUCE (gate) — defect must be real before hypotheses
    9: 0.9,   # HYPOTHESIS_GEN — the idea itself
    10: 0.8,  # EXPERIMENT_DESIGN — experiment quality (gate)
    11: 0.6,  # CODE_GENERATION
    12: 0.2,  # RESOURCE_PLANNING
    13: 0.5,  # EXPERIMENT_RUN
    14: 0.4,  # ITERATIVE_REFINE
    15: 0.5,  # RESULT_ANALYSIS
    16: 0.7,  # RESEARCH_DECISION — pivot or proceed
}
