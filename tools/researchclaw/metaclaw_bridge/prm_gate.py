...
_GATE_INSTRUCTIONS: dict[int, str] = {
    ...
    8: (
        "Evaluate whether a baseline defect was minimally reproduced with evidence. "
        "Check: (1) Does the reproduction script actually run the strongest baseline? "
        "(2) Is the claimed defect observable in the measured metrics? "
        "(3) Is the defect algorithmic/structural rather than a trivial engineering issue? "
        "(4) Is the evidence sufficient to justify building hypotheses on this defect?"
    ),
    10: (
