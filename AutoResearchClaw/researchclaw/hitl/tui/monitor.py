...
during Stage 13 (EXPERIMENT_RUN) and Stage 14 (ITERATIVE_REFINE).
...
class ExperimentMonitor:
    ...
    def get_experiment_status(self) -> dict[str, Any]:
        ...
        # Read runs from stage-13 or stage-14
        for stage in ("stage-13", "stage-14"):
        ...
        for stage in ("stage-15", "stage-13"):
