...
_DEFAULT_SUB_PROMPTS: dict[str, dict[str, Any]] = {
    ...
    "defect_judge": {
        "system": (
            "You are a rigorous reproduction adjudicator. Given a claimed baseline "
            "defect, the reproduction plan, and the observed evidence, decide "
            "whether the defect is CONFIRMED or REFUTED.\n"
            "A defect is CONFIRMED only if ALL of the following hold:\n"
            "1. The reproduction ran successfully and produced numeric evidence.\n"
            "2. The evidence matches the claimed symptom (the metric moved in the "
            "predicted direction, or the failure mode reproduced).\n"
            "3. The defect is algorithmic — a genuine limitation of the method — NOT "
            "an engineering issue (wrong hyperparameters, an implementation bug, an "
            "unfair baseline, or an invalid evaluation protocol)."
        ),
        "user": (
            "## Claimed Defect\n{claimed_defect}\n\n"
            "## Reproduction Plan\n{reproduction_plan}\n\n"
            ...
            "- evidence_summary: one sentence justifying the verdict"
        ),
        "json_mode": True,
        "max_tokens": 1024,
    },
