...
import numpy as np
from paper3.experiments.bar_depth.core import robust_affine_fit
from paper3.experiments.bar_depth.io_utils import (
    file_digest,
    read_json,
    read_jsonl,
    write_json_atomic,
)
from paper3.experiments.bar_depth.run_oracle_canary import (
